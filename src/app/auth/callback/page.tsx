...
/**
 * Página de callback para OAuth de Supabase.
 *
 * Flujo:
 * 1. Usuario autoriza en Google/Microsoft.
 * 2. Supabase redirige a /auth/callback?code=...&provider=...
 * 3. Esta página detecta el código, lo intercambia por sesión.
 * 4. Verifica suscripción y redirige al dashboard o a /suscripcion.
 */
